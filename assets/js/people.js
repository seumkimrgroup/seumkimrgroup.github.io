...
function renderCurrentMembers(memberList) {
    ...
    listDiv.className = "container container--grid people-list people-members-list";
...
function renderFormerMembers(memberList) {
    ...
    const listDiv = document.createElement("div");
    listDiv.className = "container container--grid people-list people-members-list people-alumni-list";
