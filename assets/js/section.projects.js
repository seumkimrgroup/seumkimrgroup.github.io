...
async function init() {
    ...
    slide.innerHTML = `
          <div class="inner">
            <div class="stack">
              ...
              ${project.slug ? `<div class="group"><a class="btn btn--primary" href="/projectdetail/?slug=${escapeHtml(project.slug)}">Read more</a></div>` : ""}
            </div>
          </div>
        `;
  ...
  function renderNav() {
    ...
    projects.forEach((_, i) => {
      ...
      dot.type = "button";
      dot.className =
        "carousel-nav-dot" + (i === currentIndex ? " is-active" : "");
