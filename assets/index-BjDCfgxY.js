import"./components.cards-BPO2N5aJ.js";import{e as c,f as C}from"./data-S4SCuinP.js";import{c as X}from"./card.publication-CirH_ktY.js";function D(e){if(!Array.isArray(e)||!e.length)return"";const t=e.map(r=>`<a href="${c(r.url)}" target="_blank" rel="noopener noreferrer">${c(r.text)}</a>`);let n;return t.length===1?n=t[0]:t.length===2?n=`${t[0]} and ${t[1]}`:n=`${t.slice(0,-1).join(", ")}, and ${t[t.length-1]}`,`<p class="text-secondary">More information: ${n}.</p>`}function V(e){const t=document.createElement("article");return t.className="card card--update",t.innerHTML=`
    <div class="media">
      <img
        src="${e.image||""}"
        alt="${c(e.title||"")}"
