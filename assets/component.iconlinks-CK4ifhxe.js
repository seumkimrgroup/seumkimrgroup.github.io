import{e as r}from"./util.data-BiTpGavE.js";import{c as f,d as g,e as p,f as h,g as I,h as v,i as m}from"./icons--JfbYone.js";const E={phd:{degree:"Ph.D.",display:"Ph.D. Student",priority:1},ms:{degree:"M.S.",display:"M.S. Student",priority:2},undergraduate:{degree:"B.S.",display:"Undergraduate",priority:3}};function $(e){const t=String(e||"").toLowerCase().replace(/\./g,"").replace(/-/g," ").trim();return t.includes("phd")?"phd":t.includes("ms")?"ms":t.includes("undergraduate")?"undergraduate":""}function o(e){const t=$(e);return E[t]||{degree:e||"",display:e||"",priority:9}}function y(e){return o(e.role).priority}function C(e){return o(e).display}function l(e){window.location.href=`/peopledetail/?id=${encodeURIComponent(e.slug)}`}function _(e){const t=document.createElement("div");t.className="card card--member",t.addEventListener("click",()=>l(e));const i=e.image?`<div class="media"><img src="${e.image}" alt="${r(e.name)}"></div>`:'<div class="media"></div>',n=(e.description||[]).find(a=>a.title==="RESEARCH INTERESTS"),s=n&&n.content&&n.content.length?n.content.map(r).join(", "):"";return t.innerHTML=`
    ${i}
    <div class="stack--xs">
      <h4>${r(e.name)}</h4>
  ...
  `,t}function R(e){const t=document.createElement("div");t.className="card card--alumni",t.addEventListener("click",()=>l(e));const i=o(e.role).degree,n=e.leaveYear||"",s=[i,n].filter(Boolean).join(" "),a=e.nextAffiliation&&String(e.nextAffiliation).trim()!==""?e.nextAffiliation:"";return t.innerHTML=`
    ...
    `,t}const L={email:{label:"Email",href:e=>`mailto:${e}`,external:!1,svg:v},linkedin:{label:"LinkedIn",href:e=>e,external:!0,svg:I},scholar:{label:"Google Scholar",href:e=>e,external:!0,svg:h},website:{label:"Website",href:e=>e,external:!0,svg:p},github:{label:"GitHub",href:e=>e,external:!0,svg:g},orcid:{label:"ORCID",href:e=>e,external:!0,svg:f}};function c(e){return e.map(({type:t,value:i})=>{const n=L[t],s=n?r(n.href(i)):r(i),a=n?n.label:"External link",d=n?n.svg:m,u=!n||n.external;return`<a href="${s}" class="icon" data-type="${r(t)}" aria-label="${r(a)}" title="${r(a)}"${u?' target="_blank" rel="noopener noreferrer"':""}>${d}</a>`}).join("")}function O(e){return!e||!e.length?"":c(e)}function S(e){return!e||!e.length?"":`<div class="group">${c(e)}</div>`}export{R as a,S as b,_ as c,C as f,y as g,O as r};
